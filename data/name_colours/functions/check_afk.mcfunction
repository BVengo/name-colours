...
execute as @s[tag=nc_isAFK, team=nc_0_overworld] run team join nc_1_afk_overworld
execute as @s[tag=nc_isAFK, team=nc_2_nether] run team join nc_3_afk_nether
execute as @s[tag=nc_isAFK, team=nc_4_end] run team join nc_5_afk_end
