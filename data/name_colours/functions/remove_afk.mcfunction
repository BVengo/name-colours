...
execute as @s[tag=!nc_isAFK,team=nc_afk_overworld] run team leave @s
execute as @s[tag=!nc_isAFK,team=nc_afk_nether] run team leave @s
execute as @s[tag=!nc_isAFK,team=nc_afk_end] run team leave @s
